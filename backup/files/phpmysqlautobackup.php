...
$backup_file_name = 'mysql_'.$db.'.sql.gz';
...
if ($send_email_backup) xmail($to_emailaddress,$from_emailaddress, "DKKKP:PGS Backup", $dump_buffer, $backup_file_name, $backup_type, $phpMySQLAutoBackup_version);
