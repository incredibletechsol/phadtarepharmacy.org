...
$db = "dkkkpmba_pgs"; // your MySQL database name
$mysql_username = "dkkkpmba_pgs";  // your MySQL username
$mysql_password = "Kasturi12#$";  // your MySQL password


$from_emailaddress = "dkkkpmba@lin4.plreseller.com";// your email address to show who the email is from (should be different $to_emailaddress)
$report_emailaddress = "phadtarecronmail@gmail.com";//address to send reports, not the backup just details on last backups (can be same as above)
$to_emailaddress = "phadtarecronmail@gmail.com"; // your email address to send backup files to
...
define('TOTAL_BACKUP_FILES_TO_RETAIN',1);//the total number of backups files to retain, e.g. 10. the 10 most recent files mtime (modified date) are kept, older versions are deleted
...
//$table_select[0]="friends";
//$table_select[1]="contacts";
//$table_select[2]="events";
...
// leave commented out and ALL tables will be included in the backup.
//$table_exclude[0]="friends";
//$table_exclude[1]="events";
