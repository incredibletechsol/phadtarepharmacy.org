			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<h2>Introduction To School</h2>
						</div>
						<nav id="breadcrumbs">
							<ul>
								<li>You are here:</li>
								<li>About Us</li>
								<li>Introduction To School</li>
							</ul>
						</nav>
					</div>
				</div>
