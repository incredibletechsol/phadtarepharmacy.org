...
<body>
	...
	<section class="wrapper">
		...
		<section class="content left_sidebar portfolio small-images">
			<div class="container">
				<div class="row">
					<!--Sidebar Widget-->
					<div class="col-lg-4">
					...
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="blog_large">
							<ul id="list" class="portfolio_list clearfix ">
								...
								{
								echo "<li class='list_item col-lg-3 col-md-4 col-sm-6 branding'>";
									echo "<div class='hoverlay'>";
										echo "<img src='gallery/$row[1]' height='150'/>";
