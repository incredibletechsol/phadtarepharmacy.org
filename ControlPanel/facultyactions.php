	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_path))
					{
					$faculty_insert = "INSERT INTO tbl_faculty(type,name,designation,qualification,experience,photo) values('$type','$name','$designation','$qualification','$experience','$fileName')";
					...
					$message="DKKKPPGS.COM :: 1 Faculty Inserted";
					}
				?>
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				$message="DKKKPPGS.COM :: 1 Faculty Deleted";
				?>
				...
				if($fileSize <= 0) {
					...
					mysqli_query($con,$faculty_update) or die(mysql_error()); 
						...
						if(move_uploaded_file($_FILES['photo1']['tmp_name'],$target_path))
							...
							$log->info("Updating Faculty Data  :::".$faculty_update);	
							mysqli_query($con,$faculty_update) or die(mysql_error()); 
							$message="DKKKPPGS.COM :: 1 Faculty Updated";
							}
					}
				?>
