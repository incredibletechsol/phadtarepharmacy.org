			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover" id="dataTables-example">
					...
					<tbody>
						<?php
						include('conn.php');
						$fetch_basic_profile="select * from tbl_faculty where type='Non-Teaching' order by id asc";	
						...
						while($basic_profile_row = mysqli_fetch_array($basic_profile_rs)) 
							...
							echo "<td align='center'><img src='$target_path/$basic_profile_row[6]' class='myimg'></td>";
							echo "</tr>";
							} 
						?>
					</tbody>
